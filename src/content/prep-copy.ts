...
export const home = {
  hero: {
    ...
    body: "Your projects, readable by any AI or agent, with context in seconds. Set up in one minute:",
  },
  steps: [
    {
      n: "1",
    ...
    },
    {
      ...
      body: "In ChatGPT, Claude, or Gemini, any chat with file access, say the line below. The AI reads the folder, learns the standard from it, and you're set.",
    },
  ],
...
export const about = {
  ...
  founder: {
    ...
    body: "PREP is an open standard by Rafael Carrer, a kitchen manager in London who builds his own tools for the recurring problems he meets in real work. It came from a simple frustration: knowing an AI could help, but losing everything the moment a chat grew heavy or he switched models. So he built a way to keep it. The fix was giving the project its own memory.",
    linkLabel: "Rafael's work on GitHub",
  },
  what: {
    heading: "A convention, not a product.",
    body: "PREP is a handful of plain files with agreed names. If a folder follows the standard, any tool can support it: ChatGPT, Claude, Gemini, an agent, an editor. There's no app, no account, no backend. It's designed to outlive any single AI model.",
  },
  lane: {
  ...
  contact: {
    ...
    body: "Questions, ideas, or a translation? The best place is GitHub Discussions, which is public, so answers help the next person too. For anything else, email works.",
  },
  ameti: {
